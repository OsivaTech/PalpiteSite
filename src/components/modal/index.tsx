...
const Modal = ({ display, toggle, open, setOpen, setUserExibition, setHigherRole }: any) => {
    ...
    const [user, setUser] = useState<UserType|any>({ name: '', email: '', password: '', role: 300, info: `${endereco.estado},${endereco.cidade},${endereco.rua}`, team: '', document: '', birthday: '', number: '', points: 0 })
